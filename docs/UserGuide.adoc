...
Now that you are on the edit events page, to edit a specific field, execute the following command: `edit <prefix>/<value> <prefix>/value> ...`. There are 7 different prefixes. The 7 prefixes are as follows:
...
4. Total Budget : `b/`
5. Destination : `l/`
6. Add Inventory Item : `inv/` (This prefix can be used multiple times)
7. Delete Inventory Item : `dinv/` (This prefix can be used mutliple times)
