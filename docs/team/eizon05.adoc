...
==== *Major enhancements*: Implementation of the Trip Inventory Manager_ feature

** *What it does*: The Trip Inventory Manager_ allows users to create a list of inventory items they need on their trip. Users can choose to manually add a new inventory item or add an inventory item inside of an event in the trip itinerary - which will automatically be reflected on the Trip Inventory List. If the item has already been purhcashed or packed by the user, he is able to mark it using a checkbox. 
...
** Wrote test cases for _Inventory Manager__
** Updated the UI to make it more interactive and user friendly https://github.com/AY1920S1-CS2103T-T11-4/main/pull/160[#160]

* Project management:
** Reviewed and approved several PRs
** Updated ContactUs page https://github.com/AY1920S1-CS2103T-T11-4/main/pull/16[#16]
** Created first draft of https://github.com/AY1920S1-CS2103T-T11-4/main/pull/171[#171]
...
|===
|
This section displays the section of User Guide relating to the usage of _Event_ feature were edited by me, and the _Trip Inventory Manager_ was created and edited by me.
|===
...
|===
|
This section of the Developer Guide titled _The Inventory List_ (wihch details the its' Models, User Interface and Logic) was created and edited by me.
|===
