...
** Created first draft and initial layout and plan of the User Guide https://github.com/AY1920S1-CS2103T-T11-4/main/pull/171[#171]
...
|===
|
This section displays the section of User Guide relating to the usage of inventory list in the _Event_ feature (which was edited by me), and the _Trip Inventory Manager_ was created and edited by me.
|===

include::../UserGuide.adoc[tag=event_ppp1]
